	   ...
	   <div class = "row" id = "searchbox">
		...
		<div class = "row mx-1">
			<div class = "col-12 card card-body pt-1">
				  <h4 class ="pb-2">Collection Details: </h4>
				  <h4 class ="mb-3 mt-0">Event Name</h4>
				  <div class = "row">
				  	<div class = "col-2">
			...
			<div class = "row mt-2 mx-1">
				<div class = "col-12 card card-body pt-1">
					<h4 class ="mb-3 mt-0">Items Selected in Event Name: </h4>
					<div class = "row">
						<div class = "col-md-3 col-6">
							<div class="card text-center">
							  <div class="card-body">
							    ...
							    <a href="#staticBackdropAddItem" class="btn btn-primary" data-toggle="modal">Remove Item</a>
							  </div>
							</div>
						</div>
					</div>
