...
?>
						...
						<div class="card text-center alert-success">
						  <div class="card-body text-center">
						    ...
						    <b>Qty: </b><input type="number" class = "iitqty text-center" style = "width:20%" id = "itqty" value = "<?php echo $v['r_item_qty'];?>">
						    ...
						    <button type = "button" class="btn btn-primary col-8 mt-2" id = "itedit" style = "">Edit Item</button>
						    <button type = "button" class="btn btn-primary col-8 mt-2" id = "itremove" style = "">Remove Item</button>
							</form>
						  </div>
						</div>
						</div>
